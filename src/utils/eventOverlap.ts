...
export function convertEventToDateRange({ date, startTime, endTime }: Event | EventFormType) {
  return {
...
export function isOverlapping(event1: Event | EventFormType, event2: Event | EventFormType) {
...
export function findOverlappingEvents(newEvent: Event | EventFormType, events: Event[]) {
